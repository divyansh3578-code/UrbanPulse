    ...
    <div style={{ background: 'var(--bg)' }}>
      ...
      <div style={{ background: 'var(--bg)' }} className="min-h-screen">
        <div className="hero-stage">
          ...
          <div className="hero-float-tag t1">Pothole reported</div>
          <div className="hero-float-tag t2">Drainage issue</div>
          <div className="hero-float-tag t3">Garbage overflow</div>
          <div className="hero-float-tag t4">Water leakage</div>
          <div className="hero-spin-ring" style={{ width: 50, height: 50, top: 70, right: '18%' }} />
          <div className="hero-path-dot" style={{ width: 8, height: 8, background: 'var(--orange)', top: 260, right: '38%' }} />
          <div className="hero-path-dot" style={{ width: 6, height: 6, background: 'var(--primary)', top: 190, right: '28%', animationDelay: '0.5s' }} />
          <div className="hero-path-dot" style={{ width: 6, height: 6, background: 'var(--blue)', top: 320, right: '20%', animationDelay: '1s' }} />

        <div className="max-w-6xl mx-auto px-8 py-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center" style={{ position: 'relative', zIndex: 5 }}>
          {/* Left */}
